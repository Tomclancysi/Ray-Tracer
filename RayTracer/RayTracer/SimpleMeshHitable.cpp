...
Triangle::Triangle(Vector3D pos, Vector3D len, Material *mat)
{
    translate(pos);
    scale(len);
...
Cube::Cube(Vector3D pos, Vector3D len, Material *mat)
{
    translate(pos);
    scale(len);
...
Plane::Plane(Vector3D pos, Vector3D len, Material *mat)
{
    translate(pos);
    scale(len);
